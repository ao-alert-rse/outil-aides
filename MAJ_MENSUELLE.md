...
1. **Régions hors IdF** : toutes les régions ont désormais une aide spécifique en plus du portail générique, **sauf la Corse** (agent de recherche lancé le 2026-07-02 mais interrompu par un redémarrage de process avant d'aboutir — à relancer). Pays de la Loire (2), Occitanie (2), Normandie (1) et PACA (2) ajoutées le 2026-07-02. **Points de vigilance à vérifier manuellement avant de proposer au client** : CEDRE Ambition (PACA) — l'appel 2026 semblait clos au moment de la vérification ; Aide au conseil RH (PACA) — fiche source indexée par moteur de recherche mais URL non accessible en direct au moment du contrôle.
