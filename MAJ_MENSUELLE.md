...
1. **Régions hors IdF** : Auvergne-Rhône-Alpes, Hauts-de-France, Nouvelle-Aquitaine, Bourgogne-Franche-Comté et Bretagne ont désormais une aide spécifique en plus du portail générique (Bourgogne-Franche-Comté et Bretagne ajoutées le 2026-07-02). Il reste Centre-Val de Loire, Corse, Grand Est, Normandie, Occitanie, Pays de la Loire, PACA (7 régions) — même méthode (1 agent de recherche par région, 1-2 aides phares), coût observé ~42-45k tokens/région. **Ne pas lancer sans validation explicite au préalable.**
