...
3. ~~Alerte plafond de minimis~~ — faite le 2026-07-02, **puis entièrement retirée le 2026-07-03** (calcul, UI, champ `minimis` sur les 114 aides, colonne Supabase). Raison : le calcul ne portait que sur la sélection du jour, sans historique réel du client (aides déjà perçues ailleurs, dans le temps) — jugé plus confus que réellement fiable en usage. À refaire correctement plus tard, uniquement une fois le dossier client persistant (V2) en place, pour un vrai suivi sur 3 exercices glissants.
