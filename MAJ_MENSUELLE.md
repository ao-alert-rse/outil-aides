...
1. **Régions hors IdF** : Auvergne-Rhône-Alpes, Hauts-de-France, Nouvelle-Aquitaine, Bourgogne-Franche-Comté, Bretagne, Centre-Val de Loire et Grand Est ont désormais une aide spécifique en plus du portail générique (Centre-Val de Loire et Grand Est ajoutées le 2026-07-02 ; fiche Grand Est re-vérifiée via Claude in Chrome car l'agent de recherche n'avait trouvé que le portail de dépôt, pas la fiche descriptive). Il reste Corse, Normandie, Occitanie, Pays de la Loire, PACA (5 régions) — même méthode (1 agent de recherche par région, 1-2 aides phares), coût observé ~40-61k tokens/région. **Ne pas lancer sans validation explicite au préalable.**
